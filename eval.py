...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test-data-dir",
        type=str,
        help="Location where test data is available (Local or inside the container)",
        default="/opt/ml/processing/input/data/",
    )
    parser.add_argument(
        "--model-dir",
        type=str,
        help="Location where model file (.mdl) is available (Local or inside the container)",
        default="/opt/ml/processing/input/model",
    )
    parser.add_argument(
        "--report-dir",
        type=str,
        help="Location where to save evaluation report (Local or inside the container)",
